...
export default {
  ...
  methods: {
    listData() {
      ...
      this.$api.News.fetchList(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          this.$api.News.createNews(this.temp).then(() => {
    ...
    updateData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          this.$api.News.updateNews(tempData).then(() => {
    ...
    handleFetchPv(pv) {
      this.$api.News.fetchPv(pv).then(response => {
