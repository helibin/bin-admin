  ...
  <div class="form-container">
    ...
    >
      <div class="form-main-container">
        <el-form-item
          :rules="[{ required: !isEdit, message: '请选择代理商' }]"
          label="所属代理商"
          prop="muser_id"
        >
          <el-select
            :origin-data="originData.muser_id"
            clearable
            v-model="formData.muser_id"
          >
            <el-option
              :key="d.id"
              :label="d.name"
        ...
        >
          <el-input
            :origin-data="originData.identifier"
        ...
        >
          <el-input
            :origin-data="originData.address"
        ...
        >
          <el-input
            :origin-data="originData.company"
        ...
        <el-form-item :label="$t('manageUser.status')">
          <el-switch
            :origin-data="originData.is_disabled"
            active-value="1"
            inactive-value="0"
...
export default {
  ...
  methods: {
    ...
    addData() {
      this.$api.ManageUsers.add(this.formData)
        .then(() => {
          this.$notify({
            title: '成功',
            message: '添加后台用户成功',
    ...
    modifyData(nextData) {
      this.$api.ManageUsers.modify(this.$route.params && this.$route.params.id, nextData)
        .then(() => {
          this.$notify({
            title: '成功',
            message: '修改后台用户成功',
