<template>
  <div class="form-container">
    <el-form ref="formData" :model="formData" class="form-main-container" label-width="120px">
      ...
      <el-form-item>
        <el-button v-loading="loading" style="margin-left: 10px;" type="primary" @click="submitForm">绑定 </el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    listWristband() {
      this.$baseAPI.list('my-wristbands', { by_page: false, user_id: 'null' }).then(({ data }) => {
    ...
    submitForm() {
      this.$refs.formData.validate(valid => {
        if (valid) {
          this.loading = true
          this.$api.Users.bindWristband(this.myUserId, {
