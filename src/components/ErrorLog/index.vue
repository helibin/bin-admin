<template>
  <div v-if="errorLogs.length">
    <el-badge :is-dot="true" style="line-height: 30px;" @click.native="addDialogVisible = true">
    ...
    <el-dialog :visible.sync="addDialogVisible" title="Error Log" width="80%">
